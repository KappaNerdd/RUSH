...
draw_sprite_ext(spr_MusTagBox, 0, moveX, 380, 13, 2.5, 0, c_white, 0.5);
draw_sprite_ext(spr_MusTagIcon, 0, moveX + 8, 380, 1, 1, 0, c_white, 1);
draw_sprite_ext(sprite_index, image_index, moveX + 380, 380, 1, 1, 0, c_white, 1);
